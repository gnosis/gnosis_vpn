...
generate_debian_source() {
    ...
    # Generate debian/changelog from release notes
    ...
    cp "${BUILD_DIR}/changelog/changelog.gz" "${SCRIPT_DIR}/../debian/changelog.Debian.gz"
    log_info "Copied changelog to debian/"
