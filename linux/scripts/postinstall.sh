...
echo "$LOG_PREFIX INFO: Setting ownership for configuration directory..."
...
echo "$LOG_PREFIX INFO: Enabling gnosis_vpn.service service..."
systemctl enable gnosis_vpn.service

echo "$LOG_PREFIX INFO: Starting gnosis_vpn.service service..."
