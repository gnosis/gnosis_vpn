...
test_required_files() {
    ...
    run_test "build-package.sh exists" "[[ -f '$SCRIPT_DIR/build-package.sh' ]]"
...
test_script_permissions() {
    ...
    run_test "build-package.sh is executable" "[[ -x '$SCRIPT_DIR/build-package.sh' ]]"
...
test_script_syntax() {
    ...
    run_test "build-package.sh syntax valid" "bash -n '$SCRIPT_DIR/build-package.sh'"
...
test_error_handling() {
    ...
    run_test "build-package.sh has set -euo pipefail" "grep -q 'set -euo pipefail' '$SCRIPT_DIR/build-package.sh'"
